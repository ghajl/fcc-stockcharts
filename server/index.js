            ...
            <div class="fcc-sc-container">
                <div class="fcc-sc-element" >
                    <div class="fcc-sc-link">
                        <div>
                            <a href="https://github.com/ghajl/fcc-stockcharts" target="_blank" class="fcc-sc-a">
                ...
                <div class="fcc-sc-element">
                    <div class="fcc-sc-link">
                        <div>
                            <a href="mailto:michaelknn@gmail.com?subject=Mail from SC" target="_blank"  class="fcc-sc-a">
                            <div class="fcc-sc-item">
                                <svg class="fcc-sc-icon">
...
function SearchBar(){
	const element = `<div class='fcc-sc-search-bar'>
						<form>
