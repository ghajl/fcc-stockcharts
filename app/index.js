...
import {setCards, getCardsList} from './cards';
...
function makePage(symbols){
	...
	let stocks = [];
	if(symbols) stocks = Object.keys(symbols).map(s => ({symbol: s, companyName: symbols[s]['companyName'], color: symbols[s]['color']}));
	const gitIconLink = {
    ...
    <body>
        ...
        <footer>
            ...
            <div class="fcc-sc-container">
                ${IconLink(gitIconLink)}
                ${IconLink(mailIconLink)}
            </div>
